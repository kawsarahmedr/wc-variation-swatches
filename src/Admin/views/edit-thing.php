...
<h1 class="wp-heading-inline">
	<?php esc_html_e( 'Edit Thing', 'wc-variation-swatches' ); ?>
</h1>
...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
	<div class="pev-poststuff">
		<div class="column-1">
			<div class="pev-card">
				<div class="pev-card__header">
					<h3 class="pev-card__title"><?php esc_html_e( 'Thing Details', 'wc-variation-swatches' ); ?></h3>
				...
				<div class="pev-card__body inline--fields">
					...
					<div class="pev-form-field">
						<label>
							<?php esc_html_e( 'Product', 'wc-variation-swatches' ); ?>
						</label>
						<?php
						...
						if ( $product ) {
							...
							esc_html_e( 'No product assigned.', 'wc-variation-swatches' );
						}
						?>
					</div>
					...
					<div class="pev-form-field">
						<label>
							<?php esc_html_e( 'Order', 'wc-variation-swatches' ); ?>
						</label>
						<?php
						...
						if ( $order ) {
							...
							esc_html_e( 'No order assigned.', 'wc-variation-swatches' );
						}
						?>
					...
					<div class="pev-form-field">
						...
						if ( $customer ) {
							...
							esc_html_e( 'No customer assigned.', 'wc-variation-swatches' );
						}
						?>
					</div>

					<div class="pev-form-field">
						<label for="thing_name"><?php esc_html_e( 'Name', 'wc-variation-swatches' ); ?></label>
		...
		<div class="column-2">
			<div class="pev-card">
				<div class="pev-card__header">
					<h3 class="pev-card__title"><?php esc_html_e( 'Actions', 'wc-variation-swatches' ); ?></h3>
				</div>
				<div class="pev-card__footer">
					<a class="del" href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'action', 'delete', admin_url( 'admin.php?page=wc-variation-swatches&id=' . $thing->get_id() ) ), 'bulk-things' ) ); ?>"><?php esc_html_e( 'Delete', 'wc-variation-swatches' ); ?></a>
					<button class="button button-primary"><?php esc_html_e( 'Save Thing', 'wc-variation-swatches' ); ?></button>
				</div>
			</div>
		</div>
	</div>
