...
?>
<h1><?php esc_html_e( 'Add New Thing', 'wc-variation-swatches' ); ?></h1>
<p><?php esc_html_e( 'You can create a new thing here. This form will create a thing for the user, and optionally an associated order. Created orders will be marked as pending payment.', 'wc-variation-swatches' ); ?></p>
<form method="POST" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
	<table class="form-table">
		...
		<tr valign="top">
			<th scope="row">
				<label for="name"><?php esc_html_e( 'Thing Name', 'wc-variation-swatches' ); ?></label>
			</th>
			<td>
				<input type="text" name="name" id="name" class="regular-text" value="" required/>
				<p class="description">
					<?php esc_html_e( 'Enter the name of the thing.', 'wc-variation-swatches' ); ?>
				</p>
			</td>
		</tr>
		...
		<tr valign="top">
			<th scope="row">
				<label for="thing_product"><?php esc_html_e( 'Thing Product', 'wc-variation-swatches' ); ?></label>
			</th>
			<td>
				<select id="thing_product" name="thing_product" class="wc-product-search" style="width: 300px" required>
					<option value=""><?php esc_html_e( 'Select a thing product...', 'wc-variation-swatches' ); ?></option>
				...
				<p class="description">
					<?php esc_html_e( 'Select the product associated with the thing.', 'wc-variation-swatches' ); ?>
				</p>
			</td>
		</tr>
		...
		<tr valign="top">
			<th scope="row">
				<label for="status"><?php esc_html_e( 'Thing Status', 'wc-variation-swatches' ); ?></label>
			</th>
			<td>
				<p>
					<label>
						<input type="radio" name="thing_status" value="new" class="checkbox" checked/>
						<?php esc_html_e( 'Create as a new thing.', 'wc-variation-swatches' ); ?>
					</label>
				</p>
				<p>
					<label>
						<input type="radio" name="thing_status" value="create_order" class="checkbox"/>
						<?php esc_html_e( 'Create a new corresponding order for this new thing.', 'wc-variation-swatches' ); ?>
					</label>
				</p>
				<p>
					<label>
						<input type="radio" name="thing_status" value="existing_order" class="checkbox"/>
						<?php esc_html_e( 'Assign this thing to an existing order.', 'wc-variation-swatches' ); ?>
					</label>
				</p>
			</td>
		</tr>
		<tr valign="top">
			<th scope="row">
				<label for="customer_id">
					<?php esc_html_e( 'Customer', 'wc-variation-swatches' ); ?>
				</label>
			</th>
			<td>
				<select name="customer_id" id="customer_id" class="wc-customer-search" data-placeholder="<?php esc_attr_e( 'Guest', 'wc-variation-swatches' ); ?>" data-allow_clear="true">
				</select>
				<p class="description">
					<?php esc_html_e( 'Select the customer associated with the thing.', 'wc-variation-swatches' ); ?>
				</p>
			</td>
		</tr>
		...
		<tr valign="top">
			<th scope="row">
				<label for="order_id"><?php esc_html_e( 'Order ID', 'wc-variation-swatches' ); ?></label>
			</th>
			<td>
				<input type="number" name="order_id" id="order_id" class="regular-text" value=""/>
				<p class="description">
					<?php esc_html_e( 'Enter the order id of the thing.', 'wc-variation-swatches' ); ?>
				</p>
			</td>
		</tr>
		...
		<tr valign="top">
			...
			<td>
				...
				<?php submit_button( __( 'Add Thing', 'wc-variation-swatches' ), 'primary', 'add_thing' ); ?>
			</td>
		</tr>
		</tbody>
	</table>
